...
contract ChainResolverEdgeCasesTest is Test {
    ...
    function test_001____register____________________EmptyChainName() public {
        ...
        resolver.register(IChainResolver.ChainData({label: emptyName, chainName: emptyName, owner: user1, interoperableAddress: CHAIN_ID}));
    ...
    function test_002____register____________________VeryLongChainName() public {
        ...
        resolver.register(IChainResolver.ChainData({label: longName, chainName: longName, owner: user1, interoperableAddress: CHAIN_ID}));
    ...
    function test_003____register____________________EmptyChainId() public {
        ...
        resolver.register(IChainResolver.ChainData({label: CHAIN_NAME, chainName: CHAIN_NAME, owner: user1, interoperableAddress: emptyChainId}));
    ...
    function test_004____register____________________VeryLongChainId() public {
        ...
        resolver.register(IChainResolver.ChainData({label: CHAIN_NAME, chainName: CHAIN_NAME, owner: user1, interoperableAddress: longChainId}));
